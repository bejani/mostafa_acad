...
use App\Action\Admin\User\UserToggleAction;
...
use App\Action\Admin\Backup\BackupAction;
...
// Toggle max attempts (admin & teacher)
use App\Action\Quiz\ToggleAttemptsAction;
use App\Action\Quiz\AdjustAttemptsAction;

$router->get('/admin/quizzes/toggle-attempts', new ToggleAttemptsAction());
$router->get('/teacher/quizzes/toggle-attempts', new ToggleAttemptsAction());

// adjust attempts (inc/dec)
$router->get('/admin/quizzes/attempts/change', new AdjustAttemptsAction());
$router->get('/teacher/quizzes/attempts/change', new AdjustAttemptsAction());
...
$router->get('/admin/users/toggle',  new UserToggleAction());
...
// Admin backup
$router->get('/admin/backup', new BackupAction());
...
// Questions CRUD (ā?į?į?į?į?ā? į?ā? quiz_id)
